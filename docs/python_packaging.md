...
| Issue | Output |
| --- | --- |
| #4 | `docs/python_packaging_inventory.csv` and `docs/python_packaging_inventory.json` generated by `.github/scripts/python_packaging.py inventory generate ...` |
...
| #7 | `.github/scripts/python_packaging.py guardrails` and CI job `python-packaging-guardrails` |
...
Use the JSON artifact as the execution input and the CSV artifact as the review table.
...
python .github/scripts/python_packaging.py inventory check --json docs/python_packaging_inventory.json --csv docs/python_packaging_inventory.csv
```
